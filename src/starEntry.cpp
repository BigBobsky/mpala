...
namespace mpala {
    ...
    StarEntry::StarEntry() :
        ...
        std::cout << "StarEntry page created" << std::endl;
        ...
        setButton.signal_clicked().connect(sigc::mem_fun(*this, &StarEntry::onEntryValidated));
    ...
    void StarEntry::setListener(StarEntryListener* listener) {
        this->_listener = listener;
    }


    void StarEntry::onEntryValidated() {
        std::cout << "new entry registered" << std::endl;
        if (_listener != 0) {
            int d;
            int m;
            int s;
